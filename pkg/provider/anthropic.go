...
func buildAnthropicRequest(modelID, systemPrompt string, contents []*genai.Content, opts *pipeline.GenerationOptions, stream bool) anthropicRequest {
...
func (vc *VertexClient) anthropicGenerate(ctx context.Context, modelID, systemPrompt string, contents []*genai.Content, opts *pipeline.GenerationOptions) (*genai.GenerateContentResponse, error) {
...
// end-of-stream.
func (vc *VertexClient) anthropicGenerateStream(ctx context.Context, modelID, systemPrompt string, contents []*genai.Content, opts *pipeline.GenerationOptions) iter.Seq2[*genai.GenerateContentResponse, error] {

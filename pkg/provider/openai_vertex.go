...
func buildOpenAIRequest(modelID, systemPrompt string, contents []*genai.Content, opts *pipeline.GenerationOptions, stream bool) openaiRequest {
	req := openaiRequest{
		Model:  modelID,
		Stream: stream,
	}
...
func (vc *VertexClient) openaiGenerate(ctx context.Context, publisher, modelID, systemPrompt string, contents []*genai.Content, opts *pipeline.GenerationOptions) (*genai.GenerateContentResponse, error) {
...
func (vc *VertexClient) openaiGenerateStream(ctx context.Context, publisher, modelID, systemPrompt string, contents []*genai.Content, opts *pipeline.GenerationOptions) iter.Seq2[*genai.GenerateContentResponse, error] {
